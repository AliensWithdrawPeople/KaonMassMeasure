...
#ifdef xsec_cut_cxx
xsec_cut::xsec_cut(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      std::string fname = "C:/work/Science/BINP/Kaon Mass Measure/tr_ph/mcgpj/tr_ph v9 new form factor/Merged/MCGPJ_kskl508_Merged.root";
...
Int_t xsec_cut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t xsec_cut::LoadTree(Long64_t entry)
{
...
void xsec_cut::Show(Long64_t entry)
{
...
Int_t xsec_cut::Cut(Long64_t entry)
{
