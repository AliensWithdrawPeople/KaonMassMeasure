...
int cutter_MC(std::string point) {
    ...
    // gROOT->ProcessLine(("a.Loop(\"C:/work/Science/BINP/Kaon Mass Measure/tr_ph/KnPrelim/MC/MC_Kn" + point + ".root\")").c_str());

    gROOT->LoadMacro("C:/work/Science/BINP/Kaon Mass Measure/up to date scripts for cutting/PhiToKn_MC.cpp");
    auto fname = "C:/work/Science/BINP/Kaon Mass Measure/tr_ph/KnPrelim/MC/MC_Kn" + point + ".root";
    auto file = TFile::Open((fname).c_str());
