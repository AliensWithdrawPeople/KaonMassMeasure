...
// Wed Nov  2 10:47:41 2022 by ROOT version 6.12/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         phen[31];   //[nph]
   Float_t         phth[31];   //[nph]
   Float_t         phphi[31];   //[nph]
   Float_t         phrho[31];   //[nph]
   Float_t         phen0[31];   //[nph]
   Float_t         phth0[31];   //[nph]
   Float_t         phphi0[31];   //[nph]
   Float_t         phlxe[31];   //[nph]
   Float_t         phslxe_layers[31][14];   //[nph]
   Float_t         pherr[31][3];   //[nph]
   Float_t         phcsi[31];   //[nph]
   Float_t         phbgo[31];   //[nph]
   Int_t           phflag[31];   //[nph]
   Int_t           phconv[31];   //[nph]
   Int_t           phfc[31];   //[nph]
   Int_t           nzcs_total;
   ...
   Int_t           nant;
   Int_t           antch[174];   //[nant]
   Float_t         antt0[174];   //[nant]
   Float_t         antt1[174];   //[nant]
   Float_t         anta0[174];   //[nant]
   Float_t         anta1[174];   //[nant]
   Float_t         antphi[174];   //[nant]
   Int_t           antst[174];   //[nant]
   Int_t           nmu;
   Int_t           much[48];   //[nmu]
   Float_t         mut0[48];   //[nmu]
   Float_t         mut1[48];   //[nmu]
...
#ifdef pipiCut_cxx
pipiCut::pipiCut(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("C:/work/Science/BINP/Kaon Mass Measure/tr_ph/mcgpj/tr_ph_piColl.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("C:/work/Science/BINP/Kaon Mass Measure/tr_ph/mcgpj/tr_ph_piColl.root");
      }
...
Int_t pipiCut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t pipiCut::LoadTree(Long64_t entry)
{
...
void pipiCut::Show(Long64_t entry)
{
...
Int_t pipiCut::Cut(Long64_t entry)
{
