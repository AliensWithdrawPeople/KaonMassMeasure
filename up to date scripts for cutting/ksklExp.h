...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmd//scan2018_omphi/scan2018_omphi_tr_ph_fc_e509.5_v8.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmd//scan2018_omphi/scan2018_omphi_tr_ph_fc_e509.5_v8.root");
      }
