...
// Mon Nov 29 11:00:29 2021 by ROOT version 6.22/08
// from TTree tr_ph/Tree with the non-collinear events
// found on file: root://sl10cmd//sim/tr_ph_run002278_v3.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         phen[14];   //[nph]
   Float_t         phth[14];   //[nph]
   Float_t         phphi[14];   //[nph]
   Float_t         phrho[14];   //[nph]
   Float_t         phen0[14];   //[nph]
   Float_t         phth0[14];   //[nph]
   Float_t         phphi0[14];   //[nph]
   Float_t         phlxe[14];   //[nph]
   Float_t         phslxe_layers[14][7];   //[nph]
   Float_t         pherr[14][3];   //[nph]
   Float_t         phcsi[14];   //[nph]
   Float_t         phbgo[14];   //[nph]
   Int_t           phflag[14];   //[nph]
   Int_t           phconv[14];   //[nph]
   Int_t           phfc[14];   //[nph]
   Int_t           nzcs_total;
...
#ifdef KSKLsim_cxx
KSKLsim::KSKLsim(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://sl10cmd//sim/tr_ph_run002278_v3.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://sl10cmd//sim/tr_ph_run002278_v3.root");
      }
...
Int_t KSKLsim::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t KSKLsim::LoadTree(Long64_t entry)
{
...
void KSKLsim::Show(Long64_t entry)
{
...
Int_t KSKLsim::Cut(Long64_t entry)
{
