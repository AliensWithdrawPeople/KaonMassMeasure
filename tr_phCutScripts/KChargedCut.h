...
// Mon Nov 22 10:22:17 2021 by ROOT version 6.22/08
// from TTree tr_ph/Tree with the non-collinear events
// found on file: root://sl10cmd//scan2018_omphi/scan2018_omphi_tr_ph_fc_e509.5_v8.root
//////////////////////////////////////////////////////////

#ifndef KChargedCut_h
#define KChargedCut_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   KChargedCut(TTree *tree=0);
   virtual ~KChargedCut();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(std::string histFileName = "rootFiles/KChargedCut.root");
...
#ifdef KChargedCut_cxx
KChargedCut::KChargedCut(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("E:/Science/BINP/Kaon Mass Measure/tr_ph/scan2018_omphi_tr_ph_fc_e509.5_v8.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("E:/Science/BINP/Kaon Mass Measure/tr_ph/scan2018_omphi_tr_ph_fc_e509.5_v8.root");
      }
...
KChargedCut::~KChargedCut()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t KChargedCut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t KChargedCut::LoadTree(Long64_t entry)
{
...
void KChargedCut::Init(TTree *tree)
{
...
void KChargedCut::Show(Long64_t entry)
{
...
Int_t KChargedCut::Cut(Long64_t entry)
{
