...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     Loop(std::string histFileName = "hist_kskl.root");
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://sl10cmd//scan2018_omphi/scan2018_omphi_tr_ph_fc_e509.5_v8.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://sl10cmd//scan2018_omphi/scan2018_omphi_tr_ph_fc_e509.5_v8.root");
      }
