...
int MassVsE()
{
    ...
    std::vector<Float_t> vM_Exp2 = {497.557, 497.563, 497.534, 497.56, 497.547, 497.572, 497.596, 497.567, 497.6139};
    std::vector<Float_t> vMerrExp = {0.036, 0.013, 0.009, 0.01, 0.004, 0.009, 0.008, 0.01, 0.028};
